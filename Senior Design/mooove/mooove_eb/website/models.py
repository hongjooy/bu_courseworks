...
class Activitylevel(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_activity', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
    standingpercentage = models.FloatField(db_column='standingPercentage', blank=True, null=True)  # Field name made lowercase.
    walkingpercentage = models.FloatField(db_column='walkingPercentage', blank=True, null=True)  # Field name made lowercase.
    runningpercentage = models.FloatField(db_column='runningPercentage', blank=True, null=True)  # Field name made lowercase.
    lyingdownpercentage = models.FloatField(db_column='lyingDownPercentage', blank=True, null=True)  # Field name made lowercase.
    numaverages = models.IntegerField(db_column='numAverages', blank=True, null=True)
    inheat = models.IntegerField(db_column='inHeat', default=False)  # Field name made lowercase.
    class Meta:
        managed = False
...
class Cowgroups(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_group', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
    cowgroupnum = models.IntegerField(null=True)
...
class Cowculatedlocation(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_location', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
   # idanklet = models.ForeignKey(AnkletGeneral, on_delete=models.CASCADE, db_column='idAnklet', blank=True, default=2)  # Field name made lowercase.
    rssiused = models.FloatField(db_column='rssiUsed')
    latitude = models.FloatField(blank=True, null=True)
    longitude = models.FloatField(blank=True, null=True)
    xcoord = models.FloatField(db_column='xCoord', blank=True, null=True)  # Field name made lowercase.
    ycoord = models.FloatField(db_column='yCoord', blank=True, null=True)  # Field name made lowercase.
...
class Microphoneaverage(models.Model):
    idmicrophoneaverage = models.AutoField(db_column='idMicrophoneAverage', primary_key=True)  # Field name made lowercase.
    idcow = models.ForeignKey(CowGeneral, related_name='cow_noise', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
    idfirstmicrophone = models.ForeignKey(Microphone, related_name='first', on_delete=models.CASCADE, db_column='idFirstMicrophone')  # Field name made lowercase.
    idlastmicrophone = models.ForeignKey(Microphone, related_name='last', on_delete=models.CASCADE, db_column='idLastMicrophone')  # Field name made lowercase.
    micaverage = models.FloatField(db_column='micAverage', blank=True, null=True)  # Field name made lowercase.
    timemeasured = models.DateTimeField(db_column='timeMeasured', blank=True, null=True)  # Field name made lowercase.
...
class Pulse(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_pulse', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
    idanklet = models.ForeignKey(AnkletGeneral, on_delete=models.CASCADE, db_column='idAnklet', blank=True, default=2)  # Field name made lowercase.
...
class Sociallevel(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_social', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
...
class Stepcount(models.Model):
    ...
    idcow = models.ForeignKey(CowGeneral, related_name='cow_stepcount', on_delete=models.CASCADE, db_column='idCow', blank=True, default=6)  # Field name made lowercase.
...
class Stepcountaverages(models.Model):
    idstepcountaverages = models.AutoField(db_column='idstepCountAverages', primary_key=True)  # Field name made lowercase.
    idcow = models.IntegerField(db_column='idCow')  # Field name made lowercase.
    datastarttime = models.TimeField(db_column='dataStartTime', blank=True, null=True)  # Field name made lowercase.
    dataendtime = models.TimeField(db_column='dataEndTime', blank=True, null=True)  # Field name made lowercase.
    stepcountavg = models.FloatField(db_column='stepCountAvg', blank=True, null=True)  # Field name made lowercase.
    numaverages = models.IntegerField(db_column='numAverages', blank=True, null=True)  # Field name made lowercase.
    lastupdated = models.DateTimeField(db_column='lastUpdated', blank=True, null=True)  # Field name made lowercase.
